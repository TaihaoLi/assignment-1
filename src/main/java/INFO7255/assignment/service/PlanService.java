    ...
    private Map<String, Map<String, Object>> convertToMap(JSONObject object) {
        ...
        while (iterator.hasNext()) {
            ...
            if (value instanceof JSONObject) {
                //if value is json object, call self again
                ...
                //if value is array,call convertToList
        ...
        for (String key : keys) {
            if (key.equals(redisKey)) {
                if (isDelete) {
                    ...
                    //not delete,hgetall of key and store at output map
